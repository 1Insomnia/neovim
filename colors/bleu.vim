...
let s:gui_background = "#282c34"
let s:gui_selection  = "#373b41"
let s:gui_line       = "#282a2e"
let s:gui_comment    = "#636d83"
...
let s:palette.gui.pink         = { 'dark' : "#ff78f8"        , 'light' : "#5f0000" }
let s:palette.gui.orange       = { 'dark' : "#ff936a"        , 'light' : "#875f00" }
let s:palette.gui.yellow       = { 'dark' : "#f9c859"        , 'light' : "#5f5f00" }
let s:palette.gui.green        = { 'dark' : "#3fc56b"        , 'light' : "#005f00" }
let s:palette.gui.aqua         = { 'dark' : "#87afd7"        , 'light' : "#005f5f" }
let s:palette.gui.blue         = { 'dark' : "#10b1fe"        , 'light' : "#00005f" }
...
let s:palette.gui.gitgutterchg = { 'dark' : "#ff936a"        , 'light' : "#d78700"  }
...
let s:palette.cterm.pink         = { 'dark' : "168"              , 'light' : "52"  }
...
exe "hi! Number"          .s:fg_pink       .s:bg_none        .s:fmt_none
"   Character"
"   Number"
"   Boolean"
"   Float"
