...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if get(g:, 'polar_transp_bg', 0) && !has('gui_running')
    ...
    hi Normal guifg=#000000 guibg=#f9f9f9gui=NONE cterm=NONE
  endif
  ...
  hi String guifg=#2a871f guibg=NONE gui=NONE cterm=NONE gui=italic cterm=italic
  ...
  hi Operator guifg=#7a82daguibg=NONE gui=NONE cterm=NONE
